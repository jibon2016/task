 ...
 * table rows). NoteExport this function considers all element nodes under the parent!
 *  @method  fnDomSwitch
...
$.extend( ColReorder.prototype, {
	...
	/**
	 * Get the current order of the columns, as an array. NoteExport that the values
	 ...
	 * ordering array given. NoteExport that ColReorder takes a brute force approach
	 * to reordering, so it is possible multiple reordering events will occur
	 * before the final order is settled upon.
	 *  @param {array} [set] Array of column identifiers in the new order. NoteExport
...
ColReorder.defaults = {
	 ...
	 * (`true`) or wait until the mouse is released (`false` - default). NoteExport
